<%-- 
    Document   : licen
    Created on : 17 Apr, 2017, 5:08:48 PM
    Author     : POOJA
--%>
...
<div class="panel-body">
                            <form role="form" action="licendate.jsp" method="post">
                                        <div class="form-group">
                                            <label>Select Hawker ID</label>
                                            <input class="form-control" type="text" name="uuid" />
                                        </div>
                                                                
                                        <button type="submit" class="btn btn-info">Generate Renewal Date </button>
